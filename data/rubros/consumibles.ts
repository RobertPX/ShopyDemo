...
const p = (n: number) => [
  `https://picsum.photos/seed/cons${String(n).padStart(2,"0")}a/800/600`,
  `https://picsum.photos/seed/cons${String(n).padStart(2,"0")}b/800/600`,
  `https://picsum.photos/seed/cons${String(n).padStart(2,"0")}c/800/600`,
];
